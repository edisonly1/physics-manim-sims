...
class AtwoodMachine(ParamScene):
    ...
    def construct(self):
        ...
        mobj1 = Square(0.6, color=p.obj, fill_color=p.obj, fill_opacity=0.2).move_to(left_anchor  + DOWN*(r + 2.1))
        mobj2 = Square(0.7, color=p.obj, fill_color=p.obj, fill_opacity=0.2).move_to(right_anchor + DOWN*(r + 1.9))
